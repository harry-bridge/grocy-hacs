...
TASKS: Final = "Task(s)"
ITEMS: Final = "Item(s)"
LOCATIONS: Final = "Location(s)"
UNITS: Final = "Unit(s)"

ATTR_BATTERIES: Final = "batteries"
ATTR_CHORES: Final = "chores"
ATTR_ALL_LOCATIONS: Final = "locations"
ATTR_ALL_PRODUCTS: Final = "products"
ATTR_QUANTITY_UNITS: Final = "quantity_units"
...
ATTR_STOCK_BY_LOCATION: Final = "stock_by_location"
